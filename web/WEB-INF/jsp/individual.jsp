    ...
    <div row class="row-fluid">
        ...
        <div class="col-sm-10" style="padding: 0px;">
            <div style="padding-right:0px;border: 1px solid #080808 ;height: 0px;;padding-left: 0px; background-color: #333333;padding-bottom:100% ;">
                <div id="contentPage">
                    <%--  可替换的内容--%>
                    <div class="col-sm-5" style="border:1px solid #080808; background-color: #222222;padding-bottom:55%;margin:25px 10px 0px 25px; height:0px">
                     <
                    </div>
                    <div class="col-sm-6">
                        <div class="col-sm-12" style="border:1px solid #080808; background-color: #222222;padding-bottom:25% ;margin: 25px 5px 10px 5px;height:0px">
                        <h1 class="center-block">个人中心</h1>
                        </div>
                        <div class="col-sm-12" style="border:1px solid #080808; background-color: #222222;padding-bottom:87.4% ;margin: 10px 5px 0px 5px; height:0px"></div>
                    </div>
                        <div class="col-sm-11" style="border:1px solid #080808; background-color: #222222;padding-bottom:38%;margin:20px 0px 20px 25px; height:0px"></div>
